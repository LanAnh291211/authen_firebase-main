...
class _SearchPageState extends State<SearchPage> {
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration: const InputDecoration(border: InputBorder.none, hintText: "T....", hintStyle: TextStyle(color: Colors.white, fontSize: 16)),
                  ),
                ),
                GestureDetector(
                  onTap: () {
  ...
  Widget groupTile(String userName, String groupId, String groupName, String admin) {
    ...
    return ListTile(
      ...
      subtitle: Text("Quản trị viên:  ${getName(admin)}"),
      trailing: InkWell(
        onTap: () async {
          ...
          if (isJoined) {
            ...
            showSnackbar(context, Colors.green, "tham gia thành công");
            ...
            setState(() {
              isJoined = !isJoined;
              showSnackbar(context, Colors.red, "rời khỏi nhóm $groupName");
            });
          }
        },
        child: isJoined
            ...
            : Container(
                ...
                padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                child: const Text("tham gia bây giờ", style: TextStyle(color: Colors.white)),
              ),
      ),
    );
  }
