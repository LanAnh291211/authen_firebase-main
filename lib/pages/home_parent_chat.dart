...
class HomeChatPage extends StatefulWidget {
  HomeChatPage({Key? key, this.id2 = '', this.userName2 = ''})
      : super(
          key: key,
        );
  String id2;
                  ...
                  onPressed: () async {
                    if (groupName != "") {
                      ...
                      DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
                          .createGroup(userName, FirebaseAuth.instance.currentUser!.uid, widget.id2, widget.userName2, groupName)
                          .whenComplete(() {
                        _isLoading = false;
                      });
                      Navigator.of(context).pop();
            ...
            if (snapshot.data['groups'].length != 0) {
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GroupTile(
                      groupId: getId(snapshot.data['groups'][reverseIndex]), groupName: getName(snapshot.data['groups'][reverseIndex]), userName: snapshot.data['fullName']);
                },
              );
            } else {
  ...
  noGroupWidget() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Svg(
            svgPath: SvgPath.messages,
            color: AppColors.secondaryLight,
            width: 139,
          ),
          const Text('Không có tin nhắn nào cả',
              style: TextStyles.largeBody18SemiBold),
          const SizedBox(
            height: 8,
          ),
          Text(
            'Trừ khi bạn bắt đầu 1 cuộc trò chuyện',
            style: TextStyles.caption12Regular
                .copyWith(color: AppColors.textQuarternary, height: 1),
            textAlign: TextAlign.center,
          )
        ],
      ),
